...
ax.plot(orb.obs_dates, vAs, "bo")

ax.plot(dates_fine, vB_fine, "g")
ax.plot(orb.obs_dates, vBs, "go")

ax.plot(dates_fine, vC_fine, "r")
ax.plot(orb.obs_dates, vCs, "ro")
...
for i in range(n_epochs):
    ...
    ax[-1].set_xlabel(r"$\lambda\;[\AA]$")
    fig.savefig("ST3/epoch_{}.png".format(i), dpi=300)
