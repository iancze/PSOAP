...
plot_dir = "plots/Gl570BC/"

# Load the data sets for radial velocity and astrometry

rv_data_1 = ascii.read(C.PSOAP_dir + "data/Gl570BC/rv1.txt")
rv_data_2 = ascii.read(C.PSOAP_dir + "data/Gl570BC/rv2.txt")
astro_data = ascii.read(C.PSOAP_dir + "data/Gl570BC/astro.txt")
